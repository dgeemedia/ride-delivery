...
import { MapPin, Car, RefreshCw, AlertTriangle } from 'lucide-react';
...
const LiveRides: React.FC = () => {
  ...
  // Place / update driver markers whenever rides changes
  useEffect(() => {
  ...
  // Socket: update single driver position without full reload
  useEffect(() => {
