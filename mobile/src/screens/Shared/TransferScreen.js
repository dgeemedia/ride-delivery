...
export default function TransferScreen({ navigation }) {
  ...
  return (
    // SafeAreaView handles top/sides; bottom handled by ScrollView padding
    <SafeAreaView
    ...
    >
      ...
      {/* ── Header — measure its height so KVO offset is exact ── */}
      <View
      ...
      {/* ── KEY: KeyboardAvoidingView fills all remaining space below header ── */}
      {/*   This gives ScrollView a concrete, bounded parent height              */}
      <View style={{ flex: 1 }}>
        <ScrollView
...
const s = StyleSheet.create({
  ...
  // KEY: scroll content — paddingBottom set dynamically with insets.bottom
